...
namespace PalmCommunity.Utility
{
    ...
    {
        public static string IosAppk = AppSettingHelper.GetAppSettingValue("UmengIosAppKey");
        private static string IosAppsecret = AppSettingHelper.GetAppSettingValue("UmengIosAppSecret");
        private static string AndAppk = AppSettingHelper.GetAppSettingValue("UmengAndAppKey");
        private static string AndAppsecret = AppSettingHelper.GetAppSettingValue("UmengAndAppSecret");
        private static string IsProduc = AppSettingHelper.GetAppSettingValue("IsProduction");
        ...
        public static void PushAndroidMsg(string pushtype, string isproduc, dynamic tagjsonobj, string starttime, string title, string content, string description, string thirdparty_id)
        {
            ...
            postJson.payload.body.ticker = "党员e家系统消息";
